...
$id_komentar = $id_pengguna.$id_obrolan;
...
$outp = "";
$con->query("INSERT INTO komentar_obrolan(id_obrolan,id_pengguna,isi_komentar,waktu_komentar) VALUES('$id_obrolan','$id_pengguna','$isi_komentar',NOW())");
if ($con->affected_rows > 0) {
	$outp .= '{"success":1}';
	$title = 'No.obrolan '.$id_obrolan;
