...
$q = $con->query("SELECT * FROM t_favorite_friends f, obrolan o, pengguna p WHERE f.id_teman=o.id_perangkat AND o.id_perangkat=p.id_pengguna AND f.id_pengguna='$idDevice' AND id_obrolan <= ".$lastId." ".$filterMonth."ORDER BY waktu_obrolan DESC LIMIT ".$startRow.",".$limitRow);
