...
$con->query("INSERT INTO dukungan(id_dukungan,id_pengaduan,id_pengguna,waktu_dukungan) VALUES('$id_dukungan','$id_pengaduan','$id_pengguna',NOW())");

$outp = "";
if ($con->affected_rows > 0) {
	$outp .= '{"success":"1","id_pengaduan":"'.$id_pengaduan.'","id_pengguna":"'.$id_pengguna.'"}';
    ...
    if($id_pengguna!=$target){
        ...
        $isi_notifikasi = $r2['nama_pengguna'].' memberikan dukungan pada pengaduan anda';
        $con->query("INSERT INTO notifikasi(gambar_notifikasi,gambar2_notifikasi,judul_notifikasi,isi_notifikasi,waktu_notifikasi,dibaca,halaman,id_pengguna,id_table) VALUES('http://pdambitung.96.lt/bsc/aw-pages/include/images/notifikasi/notif.png','http://pdambitung.96.lt/bsc/aw-pages/include/images/notifikasi/clock.png','Dukungan','$isi_notifikasi',NOW(),'N','pengaduan','$target','$id_pengaduan')");
    }
	//pushNotification($title, 'mendapat dukungan...','Pemberitahuan Baru',$time,2);
} else {
	$outp .= '{"success":"0","id_pengaduan":"'.$id_pengaduan.'","id_pengguna":"'.$id_pengguna.'"}';
}
